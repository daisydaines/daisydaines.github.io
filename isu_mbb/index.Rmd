...
<span style="color:black"> In order to stay relevant at any level of basketball today a team needs to be able to shoot the ball well, especially from beyond the arc. The three point shot has increased in popularity over the last ten years across all positions. </span> 
...
<span style="color:orange"> **ISU's** </span> <span style="color:black"> players put up tens of thousands of three pointers over the course of the summer from several different spots around the arc. All of this was done with one goal: **get better at shooting the 3 ball**. </span> 

* <span style="color:red"> Spoiler Alert: Although most players saw an increase in performance over the course of the summer, this did not improve three point shooting for the team during 2021-2022 season `r emoji("disappointed")`</span>
