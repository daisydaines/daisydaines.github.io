...
str(total)
#--------- first plot
ggplot(total, aes(x=date, y=Shots, color=player)) +
  geom_line() +
  theme_minimal() +
  xlab("Date") +
  ylab("Shooting Percentage") +
  ggtitle("Summer Shooting")
...
bg + scale_color_manual(breaks = c("Parker", "Buzangu", "Carlson", "Visentin"),
...
wg + scale_color_manual(breaks = c("Rodriguez","Porter", "Karstetter", "Carr", "Taylor", "Smellie"),
...
gg <- ggplot(G, aes(x=date, y=Shots, color=player)) +
  ...
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- GUARDS\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Burgin", "Sorensen", "Cool", "Ball", "Ford"),
...
aj <- ggplot(AJB, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color="black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
...
aj <- gg + scale_color_manual(breaks = c("Burgin"),
                        values=c("orange"))
...
ls <- ggplot(LCS, aes(x=date, y=Shots, color=player)) +
  ...
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Sorensen #1\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
ls <- ls + scale_color_manual(breaks = c("Sorensen"),
                        values=c("orange"))
...
gg <- ggplot(TC, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_smooth(method = "lm", fill=NA, color="black") +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  ...
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Cool #2\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Cool"),
                        values=c("orange"))
...
gg <- ggplot(MP, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color="black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Porter #3\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Porter"),
                        values=c("orange"))
...
gg <- ggplot(ET, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Taylor #4\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Taylor"),
                        values=c("orange"))
...
gg <- ggplot(AS, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Smellie #5\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Smellie"),
                        values=c("orange"))
...
gg <- ggplot(TB, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color="black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Ball #10\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Ball"),
                        values=c("orange"))
...
gg <- ggplot(JC, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color="black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Carlson #12\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Carlson"),
                        values=c("orange"))
...
gg <- ggplot(DC, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Carr #13\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Carr"),
                        values=c("orange"))
...
gg <- ggplot(KK, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Karstetter #14\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Karstetter"),
                        values=c("orange"))
...
gg <- ggplot(RF, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Ford #20\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Ford"),
                        values=c("orange"))
...
gg <- ggplot(JR, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Rodriguez #22\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Rodriguez"),
                        values=c("orange"))
...
gg <- ggplot(BP, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Parker #25\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Parker"),
                        values=c("orange"))
...
gg <- ggplot(ZV, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Visentin #32\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Visentin"),
                        values=c("orange"))
...
gg <- ggplot(GB, aes(x=date, y=Shots, color=player)) +
  geom_line(size=1.5) +
  geom_text(aes(label=Shots),hjust=-0.25, vjust=0, color= "black") + 
  geom_point(size=3) +
  theme_minimal() +
  xlab("\nDate") +
  ylab("Shooting Percentage\n") +
  ggtitle("Summer Shooting -- Buzangu #34\n") +
  theme(plot.title = element_text(size = 26, face = "bold", hjust = 0.5)) +
  theme(axis.text=element_text(size=14), 
        axis.title = element_text(size=16, face = "bold")) + 
  theme(legend.text=element_text(size=12), 
...
gg + scale_color_manual(breaks = c("Buzangu"),
                        values=c("orange"))
